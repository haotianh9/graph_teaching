...
SHORT_DESCRIPTION = (
    ...
    "在 condensation 部分，用一个 compact schematic 比较高温/低温下的 Fermi gas 与 Bose gas，"
    "再解释为什么网络类比里链接像 Bose particles、节点像 energy levels。"
...
REFERENCES = [
    ...
    ("Network Science book, Figure 6.8", "https://networksciencebook.com/#figure-6-8"),
