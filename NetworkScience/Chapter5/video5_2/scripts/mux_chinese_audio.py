...
def main() -> None:
    parser = argparse.ArgumentParser(description="Mux Chinese TTS onto Video 5.2 scenes.")
    ...
    parser.add_argument("--final-out", default="media/videos/video5_2_zh_tts_review_720p30.mp4")
